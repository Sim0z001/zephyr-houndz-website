...
const Contact = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Zephyr Houndz | Book a Grooming Session</title>
        <meta
          name="description"
          content="Contact Zephyr Houndz for expert dog grooming in Mountain Creek. Call, email, or send us a message to book your pet’s next appointment."
        />
        <meta
          name="keywords"
          content="contact Zephyr Houndz, dog grooming contact, Mountain Creek groomers, Sunshine Coast dog grooming"
        />
        <meta
          property="og:title"
          content="Contact Zephyr Houndz | Book a Grooming Session"
        />
        <meta
          property="og:description"
          content="Reach out to the Zephyr Houndz team to book a professional grooming appointment or ask questions about our services."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://www.zephyrhoundz.com.au/contact"
        />
      </Helmet>
            ...
            <div className="bg-white rounded-3xl shadow-lg p-8 mb-8">
              ...
              <form ref={form} onSubmit={handleSubmit}>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="mb-4">
                    <label
                      className="block text-zephyr-ashbrown mb-2"
                      htmlFor="name"
                    >
                      Name
                    </label>
