...
const Booking = () => {
  ...
  return (
    <>
      {/* Add Helmet for SEO */}
      <Helmet>
        <title>Book an Appointment | Zephyr Houndz Dog Grooming</title>
        <meta name="description" content="Book your dog grooming appointment with Zephyr Houndz today. Easy online scheduling, flexible options, and personalized care for your pet's grooming needs." />
        <meta name="keywords" content="dog grooming appointment, book dog groomer, Mountain Creek pet grooming, schedule dog grooming" />
        <meta property="og:title" content="Book an Appointment | Zephyr Houndz Dog Grooming" />
        <meta property="og:description" content="Schedule your dog's grooming appointment online. Quick, easy booking for professional dog grooming services in Mountain Creek." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://www.zephyrhoundz.com.au/booking" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="Book Dog Grooming | Zephyr Houndz" />
        <meta name="twitter:description" content="Schedule your dog's grooming appointment online. Professional grooming services in Mountain Creek." />
      </Helmet>
