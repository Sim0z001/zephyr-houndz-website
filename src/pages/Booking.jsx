...
const Booking = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Book a Dog Grooming Appointment | Zephyr Houndz</title>
        <meta
          name="description"
          content="Easily book your dog grooming appointment at Zephyr Houndz. Secure online booking for grooming services at our Mountain Creek studio."
        />
        <meta
          name="keywords"
          content="dog grooming booking, pet grooming Sunshine Coast, book dog wash, Zephyr Houndz appointment, Mountain Creek grooming"
        />
        <meta
          property="og:title"
          content="Book a Dog Grooming Appointment | Zephyr Houndz"
        />
        <meta
          property="og:description"
          content="Secure online booking for grooming services with Zephyr Houndz, trusted local groomers in Mountain Creek."
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://www.zephyrhoundz.com.au/booking"
        />
      </Helmet>
                ...
                <div className="bg-zephyr-mint bg-opacity-20 rounded-2xl p-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span>
                        Please ensure your pet is up to date with vaccinations
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-zephyr-mint rounded-full mr-2 mt-2"></span>
                      <span>
                        Let us know of any health concerns or special
                        requirements
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-zephyr-mint rounded-full mr-2 mt-2"></span>
                      <span>
                        For more than one dog appointment, please add a note in
                        the booking to let us know
                      </span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 bg-zephyr-mint rounded-full mr-2 mt-2"></span>
                      <span>
                        Please read and sign our service agreement. It will be
                        sent to you via text after booking request
                      </span>
                    </li>
                  </ul>
                </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-3xl shadow-lg p-8 text-center">
              <p className="text-gray-700 mb-6">
                Click below to book your appointment through our secure booking
                system.
              </p>
              <a
