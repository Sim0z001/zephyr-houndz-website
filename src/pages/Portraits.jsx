      ...
      <div className="container mx-auto px-4 pb-16">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-lg max-w-4xl mx-auto mb-10">
          ...
          <p className="mb-4 text-gray-700">
            My journey began when I created my first pet portrait for a dear friend who had lost their beloved dog. 
            It was a way to honor their pet's memory and offer comfort during a difficult time. 
            I believe every pet has a unique story, and capturing that bond in a beautiful, lasting portrait 
            helps preserve those cherished memories for years to come.
          </p>
          <p className="mb-4 text-gray-700">
            Whether it's for your own pet or a gift for a loved one, my goal is to create a meaningful piece of art 
            that reflects the love and joy pets bring into our lives.
          </p>
          <p className="text-gray-700">
            <strong>100% locally handpainted</strong> in watercolour on premium cotton paper. 
            All customised — as basic as just the pet on a plain background or without a background, 
            with or without the pet's name, additional pets on the same paper — we would love to hear the ideas from you.
          </p>
        </div>
