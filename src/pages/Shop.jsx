  ...
  const petCare = [
    {
      ...
      description: 'Infused with coconut oil, aloe vera & avocado extract. Gently removes wax and odors.',
    ...
    },
    {
      ...
      description: 'Soft, hypoallergenic cotton wipes. Removes tear stains and dirt.',
    ...
    },
    {
      ...
      description: 'Soothes and protects dry, cracked paws with coconut oil and shea butter.',
    ...
    },
    {
      ...
      description: 'Alcohol-free formula with Aloe Vera. Gently cleans and soothes ears.',
    ...
    },
    {
      ...
      description: 'Mint-flavoured, fluoride-free. Helps reduce tartar and freshen breath.',
  ...
  const kits = [
    {
      ...
      description: 'Bundle with 1x ear wipes + 1x eye wipes. Natural, alcohol-free.',
    ...
    },
    {
      ...
      description: 'Complete set with mint toothpaste + soft brush. Fights tartar & freshens breath.',
  ...
  return (
    <div className="min-h-screen bg-page-background text-gray-800 py-0">
      ...
      <section className="py-8 px-4 max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-zephyr-ashbrown mb-6 text-center">Pet Care</h2>
        <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          {petCare.map((product) => (
            <div key={product.name} className="border rounded-xl p-4 shadow hover:shadow-lg transition">
              <img
                src={product.image}
                alt={product.name}
                className="w-full h-48 object-cover rounded-md mb-4"
              />
              <h2 className="text-xl font-bold text-zephyr-ashbrown mb-2">{product.name}</h2>
      ...
      <section className="py-8 px-4 max-w-4xl mx-auto">
        <h2 className="text-3xl font-bold text-zephyr-ashbrown mb-6 text-center">Kits</h2>
